...
(defun ninja--log-to-file (message log-file)
...
(defun ninja--log-message (message)
  ...
  (ninja--log-to-file message ninja-log-file))
...
(defun ninja--log-command (message)
  "Log command MESSAGE to the command log file."
  (interactive)
  (ninja--log-to-file (concat "[COMMAND] " (message "%s" message)) ninja-log-command-file))

(defun ninja--log-command-success (message)
  "Log command MESSAGE to the command log file."
  (interactive)
  (ninja--log-to-file (concat "[SUCCESS COMMAND] " (message "%s" message)) ninja-log-command-file))

(defun ninja--log-command-error (message)
  "Log command MESSAGE to the command log file."
  (interactive)
  (ninja--log-to-file (concat "[ERROR COMMAND] " (message "%s" message)) ninja-log-command-file))

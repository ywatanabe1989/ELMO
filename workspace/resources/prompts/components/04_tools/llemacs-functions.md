...
llemacs--ensure-original-goals: nil


llemacs--escape-input-text: (text)


llemacs--escape-quotes: (text)


llemacs--escape-quotes-in-file: (file)
...
llemacs--load-monitoring-components: nil
...
llemacs--logging-meets-main-log-threshold-p: (level)
...
llemacs--monitor: (&optional pj-id)


llemacs--monitor-wsl: (&optional pj-id)
...
llemacs--parse-selection: (response)
...
llemacs--path-pj-update-symlink: (&optional pj-id)
...
llemacs--pj-update-symlink: (&optional pj-id)


llemacs--pj-update-symlink-lin: (pj-id symlink-linux)


llemacs--pj-update-symlink-linux: (pj-id symlink-linux)


llemacs--pj-update-symlink-win: (pj-id symlink-win target-path)


llemacs--pj-update-symlink-windows: (pj-id symlink-win target-path)


llemacs--run-advance-project: nil


llemacs--run-dev-analyze: nil


llemacs--run-dev-debug: nil


llemacs--run-dev-document: nil


llemacs--run-dev-optimize: nil


llemacs--run-dev-refactor: nil


llemacs--run-dev-report: nil


llemacs--run-dev-search: nil


llemacs--run-dev-test: nil


llemacs--run-dev-visualize: nil
...
llemacs--run-next-step: nil


llemacs--run-progn: (prompt)


llemacs--run-project-management: nil
...
llemacs--update-docs-functions: nil


llemacs--update-docs-variables: nil
...
llemacs-run-with-selection: (option-func-alist)
